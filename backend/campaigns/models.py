...
class Campaign(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True) #when created, timestamp new now
    updated_at = models.DateTimeField(auto_now=True) #when saved, timestamp now
